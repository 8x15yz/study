        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                {% comment %} <a class="nav-link active" href="{% url 'articles:new' %}">새 글 쓰기</a> {% endcomment %}
                {% comment %} GET/POST 함께 {% endcomment %}
                <a class="nav-link active" href="{% url 'articles:create' %}">새 글 쓰기</a>
              </li>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">정말 지우시려구요?</h5>
